    ...
    map<string, vector<vector<int> > > &configurations)
{
    ...
    for (i = 0; i < 68; i++)
    {
        discamb::string_utilities::split(cr_configuration_data[i], words);
...
ClementiRoettiData::ClementiRoettiData()
{
	int entryIdx;
    ...
    */
    ...
    setConfigurationData(configurations);
    int stoIdx, nSTO;
...
void ClementiRoettiData::getEntries(
...
const HC_WfnBankEntry &ClementiRoettiData::getEntry(
