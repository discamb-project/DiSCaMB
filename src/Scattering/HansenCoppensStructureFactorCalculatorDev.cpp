...
#include "discamb/Scattering/HansenCoppensStructureFactorCalculatorDev.h"
...
void HansenCoppensStructureFactorCalculatorDev::getCalculationTime(
    double &cpuTime,
...
void HansenCoppensStructureFactorCalculatorDev::setN_Threads(
    int n)
{
    mN_Threads = n;
    #ifdef _OPENMP
...
void HansenCoppensStructureFactorCalculatorDev::setEngineType(
...
void HansenCoppensStructureFactorCalculatorDev::setEngineSpecificSpaceGroupRepresentation()
{
...
void HansenCoppensStructureFactorCalculatorDev::calculateStructureFactors(
...
void HansenCoppensStructureFactorCalculatorDev::useCPU()
{
    setEngineType(CPU);
}

void HansenCoppensStructureFactorCalculatorDev::useGPU()
{
    setEngineType(GPU);
}

void HansenCoppensStructureFactorCalculatorDev::useCPU_IAM()
{
...
// CPU, GPU or CPU_IAM
void HansenCoppensStructureFactorCalculatorDev::setCalculationMode(
...
void HansenCoppensStructureFactorCalculatorDev::convertDerivatives(
    std::vector<TargetFunctionAtomicParamDerivatives> &dTarget_dparam) 
const
{
...
void HansenCoppensStructureFactorCalculatorDev::calculate_using_GPU(
    const Crystal &crystal,
    const std::vector<Matrix3d> &localCoordinateSystems,
    const std::vector<Vector3i> &hkl, 
    std::vector<std::complex<double> > &f,
...
double HansenCoppensStructureFactorCalculatorDev::slaterNormalizationFactor(
int powerR,
double exponent)
{
...
void HansenCoppensStructureFactorCalculatorDev::addOrbitalDensity(
