...
class UnitCell {
   public:
     ...
     */
    void set(double a, double b, double c, double alpha, double beta,
             double gamma);
    void get(double &a, double &b, double &c, double &alpha, double &beta,
             double &gamma) const;
    ...
    */
    void fractionalToCartesian(const Vector3d &fractional,
    ...
    */
    ...
    void cartesianToFractional(const Vector3d &cartesian,
                               Vector3d &fractional) const;

    /** Returns fractional to Cartesian coordinates conversion matrix \f$
    \mathbf{M} \f$ such that:
    \f{equation}{
    ...
    */
    ...
    /** Returns Cartesian to fractional coordinates conversion matrix \f$
    \mathbf{M} \f$ such that:
    \f{equation}{
