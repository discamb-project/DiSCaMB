#ifndef _DISCAMB_SCATTERING_ANYSCATTERERSTRUCTUREFACTORCALCULATOR
#define _DISCAMB_SCATTERING_ANYSCATTERERSTRUCTUREFACTORCALCULATOR
...
namespace discamb{
    ...
    */
    ...
    class AnyScattererStructureFactorCalculator
    {
    ...
    public:
        ...
        AnyScattererStructureFactorCalculator(const Crystal &crystal);
