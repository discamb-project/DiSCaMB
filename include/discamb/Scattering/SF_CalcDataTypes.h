...
/**
  \brief Structure for storing derivatives of a target function with respect to
  atomic parameters.
...
/**
\brief Structure for storing derivatives of a structure factor with respect to
atomic parameters.

Stores data for parameters of muliple atoms. E.g. atomicPostionDerivatives[i]
stores derivatives with respect to coordinates of (i+1)-th atom.
*/
