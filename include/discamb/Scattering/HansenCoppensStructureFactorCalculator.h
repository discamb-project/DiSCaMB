#ifndef _DISCAMB_SCATTERING_HANSENCOPPENSSTRUCTUREFACTORCALCULATOR_H_
#define _DISCAMB_SCATTERING_HANSENCOPPENSSTRUCTUREFACTORCALCULATOR_H_
...
class HansenCoppensStructureFactorCalculator
{
    HansenCoppensStructureFactorCalculator();

public:
    /** Calculate structure factors and their derivatives*/
    HansenCoppensStructureFactorCalculator(const Crystal &crystal, const HC_ModelParameters &parameters);
...
template<typename T>
HansenCoppensStructureFactorCalculator::WrapperForSingleHklResultProcessor<T>::WrapperForSingleHklResultProcessor(
    T &t, 
...
template<typename T>
void HansenCoppensStructureFactorCalculator::WrapperForSingleHklResultProcessor<T>::setConventions(
structural_parameters_convention::XyzCoordinateSystem xyzIn,
structural_parameters_convention::XyzCoordinateSystem xyzOut,
structural_parameters_convention::AdpConvention adpIn,
structural_parameters_convention::AdpConvention adpOut)
...
template<typename T>
void HansenCoppensStructureFactorCalculator::WrapperForSingleHklResultProcessor<T>::convert(
...
template<typename T>
void HansenCoppensStructureFactorCalculator::WrapperForSingleHklResultProcessor<T>::onPerHklCalculation(
    int hkl_idx, 
    std::complex<double> &structureFactor, 
...
#endif /*_DISCAMB_SCATTERING_HANSENCOPPENSSTRUCTUREFACTORCALCULATOR_H_*/
