#ifndef _DISCAMB_SCATTERING_HansenCoppens_SF_Engine3_H_
#define _DISCAMB_SCATTERING_HansenCoppens_SF_Engine3_H_
...
class HansenCoppens_SF_Engine3
{
public:
    HansenCoppens_SF_Engine3();
    ~HansenCoppens_SF_Engine3();
...
void HansenCoppens_SF_Engine3::calculateSF(
    ...
    T &singleHklResultsProcessor)
{
    //cout << "calls HansenCoppens_SF_Engine3_6::calculateSF" << endl;
...
template<int l_max>
std::complex<REAL> HansenCoppens_SF_Engine3::combine_multipolar_terms(
    const std::vector<std::vector<REAL> > &p_lm,
    const std::vector<REAL> &radial,
    std::vector<std::vector<REAL> > &sphericalHarmonics)
{
...
#endif /*_DISCAMB_SCATTERING_HansenCoppens_SF_Engine3_H_*/
