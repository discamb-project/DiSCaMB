...
namespace discamb{
    ...
    {
        mMultiManager = false;
        mSfCalculator = shared_ptr<AnyIamCalculator>(new AnyIamCalculator(crystal));
    ...
    void AnyScattererStructureFactorCalculator2::setSfCalculator(
		std::shared_ptr<SfCalculator> &sfCalculator)
    {
        mSfCalculator = sfCalculator;
    }
